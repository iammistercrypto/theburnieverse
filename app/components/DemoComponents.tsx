...
export function Button({
  ...
  const variantClasses = {
    primary:
      "bg-[var(--app-accent)] hover:bg-[var(--app-accent-hover)] text-[var(--background)]",
    secondary:
      "bg-[var(--app-gray)] hover:bg-[var(--app-gray-dark)] text-[var(--foreground)]",
    outline:
          ...
          {todos.map((todo) => (
            <li key={todo.id} className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[var(--app-foreground-muted)] hover:text-[var(--foreground)]"
              >
                ×
              </button>
            </li>
